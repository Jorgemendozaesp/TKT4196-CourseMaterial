...
|------------|------|------------------------------------------------------------------|-----------|-------------|
|   Ch0      |  T   |  Introduction to the course. Performance criteria for structures |         K | ma. 20.08   | 
| Ch1(1.-2.) |  T   |  Introduction to the course. Performance criteria for structures |         K | ma. 20.08   | 
